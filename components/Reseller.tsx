  ...
  return (
    <section className="bg-white py-12 px-4 text-center border-t border-gray-200">
      <div className="max-w-3xl mx-auto">
        ...
        <Link className="inline-block text-sm md:text-base text-black border border-black px-5 py-2 rounded-full hover:bg-black hover:text-white transition-all duration-200" href="/revendedor">
